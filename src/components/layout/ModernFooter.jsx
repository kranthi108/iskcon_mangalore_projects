          ...
          <div className="footer-grid">
            ...
            <div className="footer-column brand-column">
              ...
              <p className="footer-description">
                "Building a spiritual beacon for Coastal Karnataka"
              </p>
              <p className="footer-mission">
                Constructing a magnificent Centre for Culture & Education at Govardhan Hills, 
                Mangalore — a place of worship, learning, prasadam distribution, cow protection, 
                and spiritual enlightenment for all.
              </p>
            ...
            <div className="footer-column">
              ...
              <ul className="footer-links">
                <li><a href="#seva">Seva Opportunities</a></li>
                <li><a href="#progress">Construction Progress</a></li>
                <li><a href="#stories">Donor Stories</a></li>
                <li><a href="#transparency">Transparency</a></li>
                <li><a href="#about">About ISKCON</a></li>
            ...
            <div className="footer-column">
              ...
              <ul className="footer-links">
                ...
                <li><a href="#partner">Corporate Partnership</a></li>
