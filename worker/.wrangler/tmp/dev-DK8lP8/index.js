...
// .wrangler/tmp/bundle-ACORu6/strip-cf-connecting-ip-header.js
...
var require_axios = __commonJS({
  "node_modules/axios/dist/browser/axios.cjs"(exports, module) {
    ...
    var { ReadableStream: ReadableStream$1, TextEncoder: TextEncoder2 } = utils$1.global;
    ...
    validators$1.transitional = /* @__PURE__ */ __name(function transitional(validator2, version3, message) {
...
var require_nodeify = __commonJS({
  "node_modules/razorpay/dist/utils/nodeify.js"(exports, module) {
    ...
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
    init_performance2();
    var nodeify = /* @__PURE__ */ __name(function nodeify2(promise, cb) {
      if (!cb) {
...
var require_razorpay_utils = __commonJS({
  "node_modules/razorpay/dist/utils/razorpay-utils.js"(exports, module) {
    ...
    function getDateInSecs(date2) {
      return +new Date(date2) / 1e3;
    }
    __name(getDateInSecs, "getDateInSecs");
    function normalizeDate(date2) {
      return isNumber(date2) ? date2 : getDateInSecs(date2);
    }
    ...
    __name(normalizeNotes, "normalizeNotes");
    ...
    __name(getTestError, "getTestError");
    function validateWebhookSignature(body, signature, secret) {
      ...
      body = body.toString();
      var expectedSignature = crypto3.createHmac("sha256", secret).update(body).digest("hex");
    ...
    __name(validatePaymentVerification, "validatePaymentVerification");
    ...
    __name(generateOnboardingSignature, "generateOnboardingSignature");
    function encrypt(dataToEncrypt, secret) {
      try {
        ...
        var cipher = crypto2.createCipheriv("aes-128-gcm", keyBytes, iv);
...
var require_api = __commonJS({
  "node_modules/razorpay/dist/api.js"(exports, module) {
    ...
    __name(getValidHeaders, "getValidHeaders");
    ...
    var API = function() {
      ...
      _createClass(API2, [{
        key: "_createConfig",
        value: /* @__PURE__ */ __name(function _createConfig(options) {
          var config2 = {
        ...
        key: "getEntityUrl",
        value: /* @__PURE__ */ __name(function getEntityUrl(params) {
          return params.hasOwnProperty("version") ? "/" + params.version + params.url : "/" + this.version + params.url;
        }, "getEntityUrl")
      }, {
        key: "get",
        value: /* @__PURE__ */ __name(function get(params, cb) {
        ...
        key: "post",
        value: /* @__PURE__ */ __name(function post(params, cb) {
        ...
        key: "postFormData",
        value: /* @__PURE__ */ __name(function postFormData(params, cb) {
...
var require_accounts = __commonJS({
  "node_modules/razorpay/dist/resources/accounts.js"(exports, module) {
    ...
    module.exports = function(api) {
      ...
      return {
        create: /* @__PURE__ */ __name(function create(params, callback) {
          return api.post({
            version: "v2",
            url: "" + BASE_URL,
            data: params
        ...
        edit: /* @__PURE__ */ __name(function edit(accountId, params, callback) {
          return api.patch({
            version: "v2",
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(accountId, callback) {
          return api.get({
            version: "v2",
            url: BASE_URL + "/" + accountId
          }, callback);
        }, "fetch"),
        delete: /* @__PURE__ */ __name(function _delete(accountId, callback) {
          return api.delete({
            version: "v2",
            url: BASE_URL + "/" + accountId
          }, callback);
        }, "_delete"),
        uploadAccountDoc: /* @__PURE__ */ __name(function uploadAccountDoc(accountId, params, callback) {
        ...
        fetchAccountDoc: /* @__PURE__ */ __name(function fetchAccountDoc(accountId, callback) {
          return api.get({
            version: "v2",
            url: BASE_URL + "/" + accountId + "/documents"
          }, callback);
...
var require_stakeholders = __commonJS({
  "node_modules/razorpay/dist/resources/stakeholders.js"(exports, module) {
    ...
    module.exports = function(api) {
      var BASE_URL = "/accounts";
      return {
        create: /* @__PURE__ */ __name(function create(accountId, params, callback) {
          return api.post({
            version: "v2",
        ...
        edit: /* @__PURE__ */ __name(function edit(accountId, stakeholderId, params, callback) {
          return api.patch({
            version: "v2",
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(accountId, stakeholderId, callback) {
          return api.get({
            version: "v2",
            url: BASE_URL + "/" + accountId + "/stakeholders/" + stakeholderId
          }, callback);
        }, "fetch"),
        all: /* @__PURE__ */ __name(function all(accountId, callback) {
          return api.get({
            version: "v2",
            url: BASE_URL + "/" + accountId + "/stakeholders"
          }, callback);
        }, "all"),
        uploadStakeholderDoc: /* @__PURE__ */ __name(function uploadStakeholderDoc(accountId, stakeholderId, params, callback) {
          var file = params.file, rest = _objectWithoutProperties(params, ["file"]);
          return api.postFormData({
            version: "v2",
        ...
        fetchStakeholderDoc: /* @__PURE__ */ __name(function fetchStakeholderDoc(accountId, stakeholderId, callback) {
          return api.get({
            version: "v2",
            url: BASE_URL + "/" + accountId + "/stakeholders/" + stakeholderId + "/documents"
          }, callback);
...
var require_payments = __commonJS({
  "node_modules/razorpay/dist/resources/payments.js"(exports, module) {
    ...
    module.exports = function(api) {
      return {
        all: /* @__PURE__ */ __name(function all() {
          var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
          var callback = arguments[1];
          var from = params.from, to2 = params.to, count3 = params.count, skip = params.skip;
          var expand = void 0;
          if (from) {
            from = normalizeDate(from);
          }
          if (to2) {
            to2 = normalizeDate(to2);
          }
          if (params.hasOwnProperty("expand[]")) {
            expand = { "expand[]": params["expand[]"] };
          }
          count3 = Number(count3) || 10;
          skip = Number(skip) || 0;
          return api.get({
            url: "" + BASE_URL,
            data: {
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(paymentId) {
        ...
        capture: /* @__PURE__ */ __name(function capture(paymentId, amount, currency, callback) {
          if (!paymentId) {
            throw new Error("`payment_id` is mandatory");
          }
          if (!amount) {
        ...
        createPaymentJson: /* @__PURE__ */ __name(function createPaymentJson(params, callback) {
        ...
        createRecurringPayment: /* @__PURE__ */ __name(function createRecurringPayment(params, callback) {
          return api.post({
            url: BASE_URL + "/create/recurring",
            data: params
          }, callback);
        }, "createRecurringPayment"),
        edit: /* @__PURE__ */ __name(function edit(paymentId) {
          var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          var callback = arguments[2];
          if (!paymentId) {
            throw new Error("`payment_id` is mandatory");
        ...
        refund: /* @__PURE__ */ __name(function refund(paymentId) {
          var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          var callback = arguments[2];
          if (!paymentId) {
            throw new Error("`payment_id` is mandatory");
        ...
        fetchMultipleRefund: /* @__PURE__ */ __name(function fetchMultipleRefund(paymentId) {
          var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          var callback = arguments[2];
          var from = params.from, to2 = params.to, count3 = params.count, skip = params.skip, url = BASE_URL + "/" + paymentId + "/refunds";
          return api.get({
            url,
        ...
        fetchRefund: /* @__PURE__ */ __name(function fetchRefund(paymentId, refundId, callback) {
          if (!paymentId) {
        ...
        fetchTransfer: /* @__PURE__ */ __name(function fetchTransfer(paymentId, callback) {
          if (!paymentId) {
            throw new Error("payment Id` is mandatory");
          }
          return api.get({
        ...
        transfer: /* @__PURE__ */ __name(function transfer(paymentId) {
          var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          var callback = arguments[2];
          if (!paymentId) {
            throw new Error("`payment_id` is mandatory");
        ...
        bankTransfer: /* @__PURE__ */ __name(function bankTransfer(paymentId, callback) {
          if (!paymentId) {
        ...
        fetchCardDetails: /* @__PURE__ */ __name(function fetchCardDetails(paymentId, callback) {
          if (!paymentId) {
            return Promise.reject(ID_REQUIRED_MSG);
          }
          return api.get({
        ...
        fetchPaymentDowntime: /* @__PURE__ */ __name(function fetchPaymentDowntime(callback) {
          return api.get({
            url: BASE_URL + "/downtimes"
          }, callback);
        }, "fetchPaymentDowntime"),
        fetchPaymentDowntimeById: /* @__PURE__ */ __name(function fetchPaymentDowntimeById(downtimeId, callback) {
          if (!downtimeId) {
        ...
        otpGenerate: /* @__PURE__ */ __name(function otpGenerate(paymentId, callback) {
          if (!paymentId) {
        ...
        otpSubmit: /* @__PURE__ */ __name(function otpSubmit(paymentId) {
          var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          var callback = arguments[2];
          if (!paymentId) {
            return Promise.reject("payment Id is mandatory");
        ...
        otpResend: /* @__PURE__ */ __name(function otpResend(paymentId, callback) {
          if (!paymentId) {
            return Promise.reject("payment Id is mandatory");
          }
          return api.post({
        ...
        createUpi: /* @__PURE__ */ __name(function createUpi() {
          var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
          var callback = arguments[1];
        ...
        validateVpa: /* @__PURE__ */ __name(function validateVpa() {
          var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
          var callback = arguments[1];
        ...
        fetchPaymentMethods: /* @__PURE__ */ __name(function fetchPaymentMethods(callback) {
          var url = "/methods";
          return api.get({
            url
          }, callback);
    ...
    module.exports = function(api) {
      return {
        all: /* @__PURE__ */ __name(function all() {
          var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
          var callback = arguments[1];
          var from = params.from, to2 = params.to, count3 = params.count, skip = params.skip, payment_id = params.payment_id;
          var url = "/refunds";
          if (payment_id) {
        ...
        edit: /* @__PURE__ */ __name(function edit(refundId, params, callback) {
          if (!refundId) {
            throw new Error("refund Id is mandatory");
          }
          return api.patch({
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(refundId) {
          var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          var callback = arguments[2];
    ...
    module.exports = function(api) {
      return {
        all: /* @__PURE__ */ __name(function all() {
          var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
          var callback = arguments[1];
          var from = params.from, to2 = params.to, count3 = params.count, skip = params.skip, authorized = params.authorized, receipt = params.receipt;
          var expand = void 0;
          if (from) {
            from = normalizeDate(from);
          }
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(orderId, callback) {
          if (!orderId) {
        ...
        edit: /* @__PURE__ */ __name(function edit(orderId) {
          var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          var callback = arguments[2];
          if (!orderId) {
            throw new Error("`order_id` is mandatory");
        ...
        fetchPayments: /* @__PURE__ */ __name(function fetchPayments(orderId, callback) {
          if (!orderId) {
            throw new Error("`order_id` is mandatory");
          }
          return api.get({
        ...
        fetchTransferOrder: /* @__PURE__ */ __name(function fetchTransferOrder(orderId, callback) {
          if (!orderId) {
            throw new Error("`order_id` is mandatory");
          }
          return api.get({
        ...
        viewRtoReview: /* @__PURE__ */ __name(function viewRtoReview(orderId, callback) {
          return api.post({
            url: "/orders/" + orderId + "/rto_review"
          }, callback);
        }, "viewRtoReview"),
        editFulfillment: /* @__PURE__ */ __name(function editFulfillment(orderId) {
  ...
  "node_modules/razorpay/dist/resources/customers.js"(exports, module) {
    ...
    module.exports = function(api) {
      return {
        ...
        edit: /* @__PURE__ */ __name(function edit(customerId, params, callback) {
          return api.put({
            url: "/customers/" + customerId,
            data: params
          }, callback);
        }, "edit"),
        fetch: /* @__PURE__ */ __name(function fetch2(customerId, callback) {
          return api.get({
            url: "/customers/" + customerId
          }, callback);
        }, "fetch"),
        all: /* @__PURE__ */ __name(function all() {
          var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
          var callback = arguments[1];
          var count3 = params.count, skip = params.skip;
          count3 = Number(count3) || 10;
          skip = Number(skip) || 0;
          return api.get({
            url: "/customers",
        ...
        fetchTokens: /* @__PURE__ */ __name(function fetchTokens(customerId, callback) {
          return api.get({
            url: "/customers/" + customerId + "/tokens"
          }, callback);
        }, "fetchTokens"),
        fetchToken: /* @__PURE__ */ __name(function fetchToken(customerId, tokenId, callback) {
          return api.get({
            url: "/customers/" + customerId + "/tokens/" + tokenId
          }, callback);
        }, "fetchToken"),
        deleteToken: /* @__PURE__ */ __name(function deleteToken(customerId, tokenId, callback) {
          return api.delete({
            url: "/customers/" + customerId + "/tokens/" + tokenId
          }, callback);
        }, "deleteToken"),
        addBankAccount: /* @__PURE__ */ __name(function addBankAccount(customerId, params, callback) {
          return api.post({
            url: "/customers/" + customerId + "/bank_account",
            data: params
          }, callback);
        }, "addBankAccount"),
        deleteBankAccount: /* @__PURE__ */ __name(function deleteBankAccount(customerId, bankId, callback) {
          return api.delete({
            url: "/customers/" + customerId + "/bank_account/" + bankId
          }, callback);
        }, "deleteBankAccount"),
        requestEligibilityCheck: /* @__PURE__ */ __name(function requestEligibilityCheck(params, callback) {
          return api.post({
            url: "/customers/eligibility",
            data: params
          }, callback);
        }, "requestEligibilityCheck"),
        fetchEligibility: /* @__PURE__ */ __name(function fetchEligibility(eligibilityId, callback) {
          return api.get({
    ...
    module.exports = function(api) {
      return {
        all: /* @__PURE__ */ __name(function all() {
          var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
          var callback = arguments[1];
          var from = params.from, to2 = params.to, count3 = params.count, skip = params.skip, payment_id = params.payment_id, recipient_settlement_id = params.recipient_settlement_id;
          var url = "/transfers";
          if (payment_id) {
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(transferId) {
          var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          var callback = arguments[2];
          var payment_id = params.payment_id;
          if (!transferId) {
        ...
        edit: /* @__PURE__ */ __name(function edit(transferId, params, callback) {
          return api.patch({
            url: "/transfers/" + transferId,
            data: params
          }, callback);
        }, "edit"),
        reverse: /* @__PURE__ */ __name(function reverse(transferId, params, callback) {
          if (!transferId) {
            throw new Error("`transfer_id` is mandatory");
          }
        ...
        fetchSettlements: /* @__PURE__ */ __name(function fetchSettlements(callback) {
          return api.get({
  ...
  "node_modules/razorpay/dist/resources/tokens.js"(exports, module) {
    ...
    module.exports = function(api) {
      ...
      return {
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(params, callback) {
          return api.post({
            url: BASE_URL + "/fetch",
            data: params
          }, callback);
        }, "fetch"),
        delete: /* @__PURE__ */ __name(function _delete(params, callback) {
          return api.post({
            url: BASE_URL + "/delete",
            data: params
          }, callback);
        }, "_delete"),
        processPaymentOnAlternatePAorPG: /* @__PURE__ */ __name(function processPaymentOnAlternatePAorPG(params, callback) {
          return api.post({
    ...
    module.exports = function(api) {
      return {
        all: /* @__PURE__ */ __name(function all() {
          var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
          var callback = arguments[1];
          var from = params.from, to2 = params.to, count3 = params.count, skip = params.skip, otherParams = _objectWithoutProperties(params, ["from", "to", "count", "skip"]);
          var url = BASE_URL;
          if (from) {
            from = normalizeDate(from);
          }
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(virtualAccountId, callback) {
          if (!virtualAccountId) {
            return Promise.reject(ID_REQUIRED_MSG);
          }
        ...
        close: /* @__PURE__ */ __name(function close(virtualAccountId, callback) {
          if (!virtualAccountId) {
            return Promise.reject(ID_REQUIRED_MSG);
          }
          return api.post({
        ...
        fetchPayments: /* @__PURE__ */ __name(function fetchPayments(virtualAccountId, callback) {
          if (!virtualAccountId) {
            return Promise.reject(ID_REQUIRED_MSG);
          }
        ...
        addReceiver: /* @__PURE__ */ __name(function addReceiver(virtualAccountId) {
          var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          var callback = arguments[2];
          if (!virtualAccountId) {
            return Promise.reject(ID_REQUIRED_MSG);
        ...
        allowedPayer: /* @__PURE__ */ __name(function allowedPayer(virtualAccountId) {
          var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          var callback = arguments[2];
          if (!virtualAccountId) {
            return Promise.reject(ID_REQUIRED_MSG);
        ...
        deleteAllowedPayer: /* @__PURE__ */ __name(function deleteAllowedPayer(virtualAccountId, allowedPayerId, callback) {
          if (!virtualAccountId) {
            return Promise.reject(ID_REQUIRED_MSG);
          }
          if (!allowedPayerId) {
...
var require_invoices = __commonJS({
  "node_modules/razorpay/dist/resources/invoices.js"(exports, module) {
    ...
    var _require = require_razorpay_utils();
    var normalizeDate = _require.normalizeDate;
    module.exports = /* @__PURE__ */ __name(function invoicesApi(api) {
      ...
      return {
        ...
        edit: /* @__PURE__ */ __name(function edit(invoiceId) {
          var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          var callback = arguments[2];
        ...
        issue: /* @__PURE__ */ __name(function issue(invoiceId, callback) {
          if (!invoiceId) {
        ...
        delete: /* @__PURE__ */ __name(function _delete(invoiceId, callback) {
          if (!invoiceId) {
            return Promise.reject(MISSING_ID_ERROR);
          }
          var url = BASE_URL + "/" + invoiceId;
        ...
        cancel: /* @__PURE__ */ __name(function cancel(invoiceId, callback) {
          if (!invoiceId) {
            return Promise.reject(MISSING_ID_ERROR);
          }
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(invoiceId, callback) {
          if (!invoiceId) {
            return Promise.reject(MISSING_ID_ERROR);
          }
          var url = BASE_URL + "/" + invoiceId;
        ...
        all: /* @__PURE__ */ __name(function all() {
          var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
          var callback = arguments[1];
          var from = params.from, to2 = params.to, count3 = params.count, skip = params.skip, url = BASE_URL;
          if (from) {
            from = normalizeDate(from);
          }
          if (to2) {
        ...
        notifyBy: /* @__PURE__ */ __name(function notifyBy(invoiceId, medium, callback) {
          if (!invoiceId) {
            return Promise.reject(MISSING_ID_ERROR);
          }
          if (!medium) {
...
var require_iins = __commonJS({
  "node_modules/razorpay/dist/resources/iins.js"(exports, module) {
    ...
    module.exports = function(api) {
      var BASE_URL = "/iins";
      return {
        fetch: /* @__PURE__ */ __name(function fetch2(tokenIin, callback) {
          return api.get({
...
var require_paymentLink = __commonJS({
  "node_modules/razorpay/dist/resources/paymentLink.js"(exports, module) {
    ...
    var _require = require_razorpay_utils();
    var normalizeDate = _require.normalizeDate;
    module.exports = /* @__PURE__ */ __name(function paymentLinkApi(api) {
      ...
      return {
        ...
        cancel: /* @__PURE__ */ __name(function cancel(paymentLinkId, callback) {
          if (!paymentLinkId) {
            return Promise.reject(MISSING_ID_ERROR);
          }
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(paymentLinkId, callback) {
          if (!paymentLinkId) {
            return Promise.reject(MISSING_ID_ERROR);
          }
        ...
        edit: /* @__PURE__ */ __name(function edit(paymentLinkId, params, callback) {
          return api.patch({
            url: BASE_URL + "/" + paymentLinkId,
            data: params
          }, callback);
        }, "edit"),
        notifyBy: /* @__PURE__ */ __name(function notifyBy(paymentLinkId, medium, callback) {
          if (!paymentLinkId) {
            return Promise.reject(MISSING_ID_ERROR);
          }
          if (!medium) {
...
var require_plans = __commonJS({
  "node_modules/razorpay/dist/resources/plans.js"(exports, module) {
    ...
    var _require = require_razorpay_utils();
    var normalizeDate = _require.normalizeDate;
    module.exports = /* @__PURE__ */ __name(function plansApi(api) {
      ...
      return {
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(planId, callback) {
          if (!planId) {
            return Promise.reject(MISSING_ID_ERROR);
          }
...
var require_products = __commonJS({
  "node_modules/razorpay/dist/resources/products.js"(exports, module) {
    ...
    module.exports = function(api) {
      var BASE_URL = "/accounts";
      return {
        requestProductConfiguration: /* @__PURE__ */ __name(function requestProductConfiguration(accountId, params, callback) {
          return api.post({
            version: "v2",
        ...
        edit: /* @__PURE__ */ __name(function edit(accountId, productId, params, callback) {
          return api.patch({
            version: "v2",
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(accountId, productId, callback) {
          return api.get({
            version: "v2",
            url: BASE_URL + "/" + accountId + "/products/" + productId
          }, callback);
        }, "fetch"),
        fetchTnc: /* @__PURE__ */ __name(function fetchTnc(productName, callback) {
          return api.get({
            version: "v2",
...
var require_subscriptions = __commonJS({
  "node_modules/razorpay/dist/resources/subscriptions.js"(exports, module) {
    ...
    var _require = require_razorpay_utils();
    var normalizeDate = _require.normalizeDate;
    module.exports = /* @__PURE__ */ __name(function subscriptionsApi(api) {
      ...
      return {
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(subscriptionId, callback) {
          if (!subscriptionId) {
            return Promise.reject(MISSING_ID_ERROR);
          }
        ...
        update: /* @__PURE__ */ __name(function update(subscriptionId, params, callback) {
          var url = BASE_URL + "/" + subscriptionId;
          if (!subscriptionId) {
            return Promise.reject(MISSING_ID_ERROR);
          }
        ...
        pendingUpdate: /* @__PURE__ */ __name(function pendingUpdate(subscriptionId, callback) {
        ...
        cancelScheduledChanges: /* @__PURE__ */ __name(function cancelScheduledChanges(subscriptionId, callback) {
        ...
        pause: /* @__PURE__ */ __name(function pause(subscriptionId) {
          var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          var callback = arguments[2];
        ...
        resume: /* @__PURE__ */ __name(function resume(subscriptionId) {
          var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          var callback = arguments[2];
        ...
        deleteOffer: /* @__PURE__ */ __name(function deleteOffer(subscriptionId, offerId, callback) {
        ...
        cancel: /* @__PURE__ */ __name(function cancel(subscriptionId) {
        ...
        createAddon: /* @__PURE__ */ __name(function createAddon(subscriptionId, params, callback) {
        ...
        createRegistrationLink: /* @__PURE__ */ __name(function createRegistrationLink() {
          var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
          var callback = arguments[1];
          return api.post({
...
var require_addons = __commonJS({
  "node_modules/razorpay/dist/resources/addons.js"(exports, module) {
    ...
    module.exports = function(api) {
      ...
      return {
        fetch: /* @__PURE__ */ __name(function fetch2(addonId, callback) {
          if (!addonId) {
            return Promise.reject(MISSING_ID_ERROR);
          }
        ...
        delete: /* @__PURE__ */ __name(function _delete(addonId, callback) {
          if (!addonId) {
            return Promise.reject(MISSING_ID_ERROR);
          }
          var url = BASE_URL + "/" + addonId;
...
var require_settlements = __commonJS({
  "node_modules/razorpay/dist/resources/settlements.js"(exports, module) {
    ...
    module.exports = function(api) {
      ...
      return {
        createOndemandSettlement: /* @__PURE__ */ __name(function createOndemandSettlement() {
          var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
          var callback = arguments[1];
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(settlementId, callback) {
          if (!settlementId) {
        ...
        fetchOndemandSettlementById: /* @__PURE__ */ __name(function fetchOndemandSettlementById(settlementId) {
          var param = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          var callback = arguments[2];
          var expand = void 0;
          if (!settlementId) {
        ...
        fetchAllOndemandSettlement: /* @__PURE__ */ __name(function fetchAllOndemandSettlement() {
          var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
          var callback = arguments[1];
          var expand = void 0;
          var from = params.from, to2 = params.to, count3 = params.count, skip = params.skip, url = BASE_URL + "/ondemand";
          if (params.hasOwnProperty("expand[]")) {
            expand = { "expand[]": params["expand[]"] };
          }
          return api.get({
        ...
        reports: /* @__PURE__ */ __name(function reports() {
          var params = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
          var callback = arguments[1];
          var day = params.day, count3 = params.count, skip = params.skip, url = BASE_URL + "/recon/combined";
          return api.get({
            url,
            data: _extends({}, params, {
              day,
  ...
  "node_modules/razorpay/dist/resources/qrCode.js"(exports, module) {
    ...
    module.exports = function(api) {
      ...
      return {
        ...
        fetchAllPayments: /* @__PURE__ */ __name(function fetchAllPayments(qrCodeId) {
          var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          var callback = arguments[2];
          var from = params.from, to2 = params.to, count3 = params.count, skip = params.skip, url = BASE_URL + "/" + qrCodeId + "/payments";
          return api.get({
            url,
            data: _extends({}, params, {
              from,
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(qrCodeId, callback) {
          if (!qrCodeId) {
        ...
        close: /* @__PURE__ */ __name(function close(qrCodeId, callback) {
          if (!qrCodeId) {
            return Promise.reject("qrCode Id is mandatroy");
          }
  ...
  "node_modules/razorpay/dist/resources/items.js"(exports, module) {
    ...
    module.exports = function(api) {
      return {
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(itemId, callback) {
          if (!itemId) {
        ...
        edit: /* @__PURE__ */ __name(function edit(itemId) {
          var params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          var callback = arguments[2];
          if (!itemId) {
            throw new Error("`item_id` is mandatory");
        ...
        delete: /* @__PURE__ */ __name(function _delete(itemId, callback) {
          if (!itemId) {
            throw new Error("`item_id` is mandatory");
          }
          return api.delete({
  ...
  "node_modules/razorpay/dist/resources/cards.js"(exports, module) {
    ...
    module.exports = function(api) {
      return {
        ...
        requestCardReference: /* @__PURE__ */ __name(function requestCardReference(params, callback) {
          return api.post({
...
var require_webhooks = __commonJS({
  "node_modules/razorpay/dist/resources/webhooks.js"(exports, module) {
    ...
    module.exports = function(api) {
      var BASE_URL = "/accounts";
      return {
        create: /* @__PURE__ */ __name(function create(params, accountId, callback) {
        ...
        edit: /* @__PURE__ */ __name(function edit(params, webhookId, accountId, callback) {
        ...
        all: /* @__PURE__ */ __name(function all() {
          ...
          count3 = Number(count3) || 10;
          skip = Number(skip) || 0;
          var data = _extends({}, params, { from, to: to2, count: count3, skip });
          if (accountId) {
            return api.get({
              version: "v2",
              url: BASE_URL + "/" + accountId + "/webhooks/",
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(webhookId, accountId, callback) {
          return api.get({
            version: "v2",
            url: BASE_URL + "/" + accountId + "/webhooks/" + webhookId
          }, callback);
        }, "fetch"),
        delete: /* @__PURE__ */ __name(function _delete(webhookId, accountId, callback) {
          return api.delete({
            version: "v2",
            url: BASE_URL + "/" + accountId + "/webhooks/" + webhookId
          }, callback);
  ...
  "node_modules/razorpay/dist/resources/documents.js"(exports, module) {
    ...
    module.exports = function(api) {
      ...
      return {
        ...
        fetch: /* @__PURE__ */ __name(function fetch2(documentId, callback) {
          return api.get({
...
var require_disputes = __commonJS({
  "node_modules/razorpay/dist/resources/disputes.js"(exports, module) {
    ...
    module.exports = function(api) {
      ...
      return {
        fetch: /* @__PURE__ */ __name(function fetch2(disputeId, callback) {
          return api.get({
        ...
        accept: /* @__PURE__ */ __name(function accept(disputeId, callback) {
          return api.post({
            url: BASE_URL + "/" + disputeId + "/accept"
          }, callback);
        }, "accept"),
        contest: /* @__PURE__ */ __name(function contest(disputeId, param, callback) {
          return api.patch({
  ...
  "node_modules/razorpay/dist/razorpay.js"(exports, module) {
    ...
    var Razorpay2 = function() {
      _createClass(Razorpay3, null, [{
        ...
        value: /* @__PURE__ */ __name(function validateWebhookSignature() {
      ...
      __name(Razorpay3, "Razorpay");
      _createClass(Razorpay3, [{
        key: "addResources",
        value: /* @__PURE__ */ __name(function addResources() {
          Object.assign(this, {
...
// .wrangler/tmp/bundle-ACORu6/middleware-loader.entry.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// .wrangler/tmp/bundle-ACORu6/middleware-insertion-facade.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
var Ai = I((Dh, _i) => {
  ...
  var Aa = a(function(r) {
    ...
    r(
      ...
      1005,
      Yt
    ), r(1007, Yt), r(1028, Yt), r(1016, _a158), r(1017, Aa), r(1021, Zt), r(1022, Zt), r(1231, Zt), r(1014, ne2), r(1015, ne2), r(1008, ne2), r(1009, ne2), r(1040, ne2), r(1041, ne2), r(1115, Jt), r(
      1182,
      Jt
...
__name(Table, "Table");
__publicField(Table, _a24, "Table");
/** @internal */
...
_a35 = entityKind;
__publicField(SelectionProxyHandler, _a35, "SelectionProxyHandler");
...
var PgTable = class extends Table {
  /**@internal */
  [(_a120 = entityKind, InlineForeignKeys)] = [];
  /** @internal */
  [EnableRLS] = false;
  /** @internal */
...
__publicField(PgTable, _a120, "PgTable");
/** @internal */
...
_a153 = entityKind;
__publicField(NeonHttpPreparedQuery, _a153, "NeonHttpPreparedQuery");
var _a154;
...
_a154 = entityKind;
__publicField(NeonHttpSession, _a154, "NeonHttpSession");
var _a155;
...
_a155 = entityKind;
__publicField(NeonTransaction, _a155, "NeonHttpTransaction");
...
_a156 = entityKind;
__publicField(NeonHttpDriver, _a156, "NeonHttpDriver");
...
_a157 = entityKind;
__publicField(NeonHttpDatabase, _a157, "NeonHttpDatabase");
...
app.post("/api/webhook/razorpay", async (c) => {
  const sqlNeon = Xs(c.env.DATABASE_URL);
  ...
  try {
    ...
    const body = await c.req.text();
    if (WEBHOOK_SECRET) {
      const expected = crypto_default.createHmac("sha256", WEBHOOK_SECRET).update(body).digest("hex");
    ...
    const ist = (/* @__PURE__ */ new Date()).toLocaleString("en-IN", { timeZone: "Asia/Kolkata" });
    switch (event.event) {
      case "payment.captured": {
        const p2 = event.payload.payment.entity;
        const donorId = p2.notes?.donorId ? Number(p2.notes.donorId) : null;
        if (p2.order_id) {
          await db.update(orders).set({
            ...
            updatedAtIst: ist
          }).where(eq(orders.razorpayOrderId, p2.order_id));
        }
        const existing = await db.select({ id: payments.id }).from(payments).where(eq(payments.razorpayPaymentId, p2.id));
        if (existing.length === 0) {
          await db.insert(payments).values({
            razorpayPaymentId: p2.id,
            razorpayOrderId: p2.order_id || null,
            donorId,
            amount: String(p2.amount / 100),
          ...
          await db.update(payments).set({
            ...
            updatedAt: /* @__PURE__ */ new Date(),
            updatedAtIst: ist
          }).where(eq(payments.razorpayPaymentId, p2.id));
        }
        break;
      }
      case "payment.failed": {
        ...
        if (existing.length === 0) {
          await db.insert(payments).values({
            razorpayPaymentId: p2.id,
            razorpayOrderId: p2.order_id || null,
            donorId: p2.notes?.donorId ? Number(p2.notes.donorId) : null,
            status: "failed",
            errorReason: p2.error_description || "Unknown",
            verifiedVia: "webhook",
            createdAtIst: ist,
            updatedAtIst: ist
          });
      ...
      case "subscription.charged": {
        ...
        await db.update(subscriptions).set({
          ...
          lastChargedAt: /* @__PURE__ */ new Date(),
          updatedAt: /* @__PURE__ */ new Date(),
          updatedAtIst: ist
        }).where(eq(subscriptions.razorpaySubscriptionId, s.id));
        if (p2) {
    ...
    console.error("Error processing Razorpay webhook:", error3);
    return c.json({ error: "Webhook processing failed", message: error3.message }, 500);
  }
});
app.use("*", cors({
...
app.use("*", async (c, next) => {
  try {
    ...
    c.set("razor", new import_razorpay.default({
...
function istNow() {
  return (/* @__PURE__ */ new Date()).toLocaleString("en-IN", { timeZone: "Asia/Kolkata" });
}
__name(istNow, "istNow");
...
app.post("/api/register-donor", async (c) => {
  try {
    ...
    if (!name?.trim())
      return c.json({ error: "Name is mandatory" }, 400);
    if (!phone?.trim())
      return c.json({ error: "Phone number is mandatory" }, 400);
    const cleanPhone = phone.replace(/\s+/g, "").trim();
    const existing = await db.select({ id: donors.id }).from(donors).where(eq(donors.phone, cleanPhone)).limit(1);
    if (existing.length > 0) {
...
app.post("/api/verify-payment", async (c) => {
  try {
    ...
    const expectedSig = crypto_default.createHmac("sha256", c.env.RAZORPAY_KEY_SECRET).update(razorpay_order_id + "|" + razorpay_payment_id).digest("hex");
...
app.post("/api/verify-subscription", async (c) => {
  try {
    ...
    const expectedSig = crypto_default.createHmac("sha256", c.env.RAZORPAY_KEY_SECRET).update(razorpay_payment_id + "|" + razorpay_subscription_id).digest("hex");
    if (razorpay_signature !== expectedSig) {
      return c.json({ success: false, message: "Verification failed" }, 400);
    }
    const ist = istNow();
...
app.post("/api/check-payment", async (c) => {
  try {
    ...
    if (payment.status === "captured") {
      ...
      const existing = await db.select({ id: payments.id }).from(payments).where(eq(payments.razorpayPaymentId, paymentId));
      if (existing.length === 0) {
        await db.insert(payments).values({
...
app.get("/api/donations", async (c) => {
  try {
    ...
    }).from(payments).leftJoin(orders, eq(payments.razorpayOrderId, orders.razorpayOrderId)).leftJoin(donors, eq(payments.donorId, donors.id)).orderBy(desc(payments.createdAt));
...
app.get("/api/subscriptions", async (c) => {
  try {
    ...
    const result = await db.select({
      ...
      donorEmail: donors.email,
      donorPhone: donors.phone
    }).from(subscriptions).leftJoin(donors, eq(subscriptions.donorId, donors.id)).orderBy(desc(subscriptions.createdAt));
    return c.json(result);
  } catch (err) {
